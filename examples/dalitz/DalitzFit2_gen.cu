...
DalitzPlotPdf* makeSignalPdf (GooPdf* eff ) {
  ...
  ResonancePdf* f0_980  = new ResonancePdf("f0_980", 
							       fixAmps ? new Variable("f0_980_amp_real",  0.008 * (-MMass2)) : 
							       new Variable("f0_980_amp_real",  0.008 * (-MMass2), 0.001, 0, 0),
							       fixAmps ? new Variable("f0_980_amp_imag", -0.013 * (-MMass2)) : 
							       new Variable("f0_980_amp_imag", -0.013 * (-MMass2), 0.1, 0, 0),  
							       new Variable("f0_980_mass",     0.9399/*0.980*/, 0.01, 0.8, 1.2),
							       new Variable("f0_980_width",    0.199/*0.044*/, 0.001, 0.001, 0.08),
                                   new Variable("f0_980_rg2og1",    3.0, 0.1, 1e-3, 10),
//							       (unsigned int)0,
							       PAIR_23, RES_FLATTE);
  
  ResonancePdf* f0_1370  = new ResonancePdf("f0_1370", 
								fixAmps ? new Variable("f0_1370_amp_real", -0.058 * (-MMass2)) : 
								new Variable("f0_1370_amp_real", -0.058 * (-MMass2), 0.001, 0, 0),
								fixAmps ? new Variable("f0_1370_amp_imag",  0.026 * (-MMass2)) : 
								new Variable("f0_1370_amp_imag",  0.026 * (-MMass2), 0.1, 0, 0),  
  ...
  ResonancePdf* f0_1500  = new ResonancePdf("f0_1500", 
								fixAmps ? new Variable("f0_1500_amp_real", 0.057 * (-MMass2)) : 
								new Variable("f0_1500_amp_real", 0.057 * (-MMass2), 0.001, 0, 0),
								fixAmps ? new Variable("f0_1500_amp_imag", 0.012 * (-MMass2)) : 
								new Variable("f0_1500_amp_imag", 0.012 * (-MMass2), 0.1, 0, 0),  
  ...
  ResonancePdf* f0_1710  = new ResonancePdf("f0_1710", 
								fixAmps ? new Variable("f0_1710_amp_real", 0.070 * (-MMass2)) : 
								new Variable("f0_1710_amp_real", 0.070 * (-MMass2), 0.001, 0, 0),
								fixAmps ? new Variable("f0_1710_amp_imag", 0.087 * (-MMass2)) : 
								new Variable("f0_1710_amp_imag", 0.087 * (-MMass2), 0.1, 0, 0),  
  ...
  ResonancePdf* f0_600  = new ResonancePdf("f0_600", 
							       fixAmps ? new Variable("f0_600_amp_real", 0.068 * (-MMass2)) : 
							       new Variable("f0_600_amp_real", 0.068 * (-MMass2), 0.001, 0, 0),
							       fixAmps ? new Variable("f0_600_amp_imag", 0.010 * (-MMass2)) : 
							       new Variable("f0_600_amp_imag", 0.010 * (-MMass2), 0.1, 0, 0),  
